<div class="page">
	<div class="container column-container">
		...
		<div class="eight column">
			...
			if (isset($_POST['sent'])) {
				...
				if (empty($errors)) {
					...
					require('email-config.php'); // not included in git repo
			...
			?>
			<p>If you'd like to get in touch with me, please feel free to
				<strong>send me an email</strong> with the form below, or use any of the other channels listed on this page. I'd love to hear from you, and I will get back to you as soon as possible - at most in a day or two.
			</p>
		...
		<div class="three column">
			...
			<p>
				<i class="fa fa-envelope"></i>&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:mark@ormo.me" class="nonlink">mark@ormo.me</a>
			</p>
			<p><i class="fa fa-skype"></i>&nbsp;&nbsp;&nbsp;&nbsp;mark.ormo</p>
			<p>
				<i class="fa fa-twitter"></i>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.twitter.com/m_s_ormo" rel="external" class="nonlink">@m_s_ormo</a>
			</p>
		</div>
